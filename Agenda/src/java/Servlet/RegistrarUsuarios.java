...
public class RegistrarUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idusuario = request.getParameter("idusuarior");
        String contraseña = request.getParameter("passwordr");
        ...
        if(consulta.registrar(idusuario, contraseña, nombres, apellidos, correo, fechanacimiento, telefono, direccion, foto, administrador)){
