...
public class EditarProyecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idevento = request.getParameter("idproyecto");
        String foto = "evento.jpg";
        ...
        if(consulta.editarevento(titulo, lugar, detalles, fecha, foto, horainicio, horafin, tipo, idevento)){
            response.sendRedirect("inicio.jsp");
        }
        else{
            response.sendRedirect("proyectosedit.jsp?id="+idevento);
        }
    }
